...
def test_ma():
    ...
    print(factor.get_pipe_df().tail())

    # compare with east money manually
    ma5 = factor.get_pipe_df()['ma5']
    ma10 = factor.get_pipe_df()['ma10']
    ma30 = factor.get_pipe_df()['ma30']
...
def test_macd():
    ...
    # compare with east money manually
    diff = factor.get_pipe_df()['diff']
    dea = factor.get_pipe_df()['dea']
    macd = factor.get_pipe_df()['macd']
