...
def test_jq_1mon_kdata():
    ...
    assert se['qfq_open'] == 5.51
    assert se['qfq_high'] == 6.51
    assert se['qfq_low'] == 5.26
    assert se['qfq_close'] == 5.52
...
def test_jq_1wk_kdata():
    ...
    # make sure our fq is ok
    assert se['qfq_open'] == 13.45
    assert se['qfq_high'] == 14.08
    assert se['qfq_low'] == 12.52
    assert se['qfq_close'] == 13.47
