...
def report_core_company():
    while True:
        ...
        try:
            ...
            email_action.send_message(['5533061@qq.com','manstiilin@protonmail.com','2315983623@qq.com','348886500@qq.com','laosiji@protonmail.com'], f'{to_time_str(target_date)} 核心资产选股结果', msg)
