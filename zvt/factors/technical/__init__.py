...
# import all from submodule solo_factor
from .solo_factor import *
from .solo_factor import __all__ as _solo_factor_all
__all__ += _solo_factor_all
...
# import all from submodule money_flow_factor
from .money_flow_factor import *
from .money_flow_factor import __all__ as _money_flow_factor_all
__all__ += _money_flow_factor_all
