...
#
# from zvt.domain import FinanceFactor, SharesChange
#
...
#
#
# class JqShareChangeRecorder(JoinquantTimestampsDataRecorder):
...
#                                                      finance.STK_CAPITAL_CHANGE.pub_date >= to_time_str(
#                                                          start)).order_by(
#                 finance.STK_CAPITAL_CHANGE.pub_date).limit(size))
#
#         df.drop(['id', 'company_id', 'company_name', 'code'], axis=1, inplace=True)
#
...
#                                  filters=[self.data_schema.timestamp == self.data_schema.change_date,
...
#                                                        FinanceFactor.report_date <= the_data_list[
#                                                            -1].report_date, ])
#
