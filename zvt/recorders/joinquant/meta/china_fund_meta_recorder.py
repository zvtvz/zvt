...
class JqChinaFundStockRecorder(TimeSeriesDataRecorder):
    ...
    def __init__(self, entity_ids=None, codes=None, day_data=True, force_update=False, sleeping_time=5,
                 default_size=2000, real_time=False, fix_duplicate_way='add', start_timestamp=None, end_timestamp=None,
                 ) -> None:
        super().__init__(force_update, sleeping_time, ['sh', 'sz'], entity_ids, codes, day_data,
                         default_size=default_size, real_time=real_time, fix_duplicate_way=fix_duplicate_way,
