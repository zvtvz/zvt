...
from zvt.domain import HoldTradeDetail
...
class EmDividendDetailRecorder(TimeSeriesDataRecorder):
    ...
    def record(self, entity, start, end, size, timestamps):
        ...
        df['holder_change_prop'] = abs(df['CHANGENUM'] / df['TOTALSHARE']).astype(float)*1000
        df['holder_change_prop'] = df['holder_change_prop'].round(5)
