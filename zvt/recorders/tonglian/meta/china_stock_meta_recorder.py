...
class TlChinaStockRecorder(BaseTlChinaMetaRecorder):
    data_schema = Stock
...
class TlChinaEtfRecorder(BaseTlChinaMetaRecorder):
    data_schema = Etf
...
class TlChinaStockEtfPortfolioRecorder(TimeSeriesDataRecorder):
...
__all__ = ['TlChinaStockRecorder', 'TlChinaEtfRecorder', 'TlChinaStockEtfPortfolioRecorder']

if __name__ == '__main__':
    # TlChinaStockRecorder().run()
    TlChinaStockEtfPortfolioRecorder(codes=['510050']).run()
